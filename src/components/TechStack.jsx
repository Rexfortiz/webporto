    ...
    >
      ...
      >
        ...
        <div className="mt-5 w-[992px] flex flex-col relative justify-center items-center h-[900px] ">
          <img src="/images/selfphoto5.png" className="absolute top-32 z-[2] max-xl:left-72 max-xl:top-36 max-xl:w-[500px] w-[700px] left-36" />
          <h2 className="tech-text flex z-[1] relative top-[-210px] justify-center items-center max-xl:text-[120px] text-[160px]  font-black">TECH STACK</h2>
          <h2 className="tech-text max-xl:top-[-390px] top-[-450px] relative z-[3] justify-center items-center max-xl:text-[120px] text-[160px] text-transparent font-black">TECH STACK</h2>
          <div ref={wrapperDivRef} className="overflow-hidden max-xl:w-[70%] w-full bottom-20 px-5 absolute z-[3]">
